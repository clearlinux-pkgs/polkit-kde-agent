...
Version  : 1.5.27.6
Release  : 69
URL      : https://download.kde.org/stable/plasma/5.27.6/polkit-kde-agent-1-5.27.6.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.6/polkit-kde-agent-1-5.27.6.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.6/polkit-kde-agent-1-5.27.6.tar.xz.sig
...
%prep
%setup -q -n polkit-kde-agent-1-5.27.6
cd %{_builddir}/polkit-kde-agent-1-5.27.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687283948
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/polkit-kde-agent-1-5.27.6/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/polkit-kde-agent/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0 || :
cp %{_builddir}/polkit-kde-agent-1-5.27.6/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/polkit-kde-agent/3e8971c6c5f16674958913a94a36b1ea7a00ac46 || :
pushd clr-build-avx2
%make_install_v3  || :
popd
pushd clr-build
