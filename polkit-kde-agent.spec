...
Version  : 1.5.24.2
Release  : 45
URL      : https://download.kde.org/stable/plasma/5.24.2/polkit-kde-agent-1-5.24.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.24.2/polkit-kde-agent-1-5.24.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.24.2/polkit-kde-agent-1-5.24.2.tar.xz.sig
...
%prep
%setup -q -n polkit-kde-agent-1-5.24.2
cd %{_builddir}/polkit-kde-agent-1-5.24.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645665293
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/polkit-kde-agent-1-5.24.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/polkit-kde-agent/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/polkit-kde-agent-1-5.24.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/polkit-kde-agent/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
