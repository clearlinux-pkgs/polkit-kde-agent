...
Source0  : https://download.kde.org/stable/plasma/5.16.3/polkit-kde-agent-1-5.16.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.3/polkit-kde-agent-1-5.16.3.tar.xz.sig
...
%prep
%setup -q -n polkit-kde-agent-1-5.16.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562740100
mkdir -p clr-build
pushd clr-build
