...
Version  : 1.6.3.5
Release  : 98
URL      : https://download.kde.org/stable/plasma/6.3.5/polkit-kde-agent-1-6.3.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.5/polkit-kde-agent-1-6.3.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.5/polkit-kde-agent-1-6.3.5.tar.xz.sig
...
%setup -q -n polkit-kde-agent-1-6.3.5
cd %{_builddir}/polkit-kde-agent-1-6.3.5
pushd ..
cp -a polkit-kde-agent-1-6.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747152320
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/polkit-kde-agent-1-6.3.5/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/polkit-kde-agent/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0 || :
cp %{_builddir}/polkit-kde-agent-1-6.3.5/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/polkit-kde-agent/3e8971c6c5f16674958913a94a36b1ea7a00ac46 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
