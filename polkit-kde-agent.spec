...
Source0  : https://download.kde.org/stable/plasma/5.20.0/polkit-kde-agent-1-5.20.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.20.0/polkit-kde-agent-1-5.20.0.tar.xz.sig
...
%prep
%setup -q -n polkit-kde-agent-1-5.20.0
cd %{_builddir}/polkit-kde-agent-1-5.20.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602693991
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/polkit-kde-agent-1-5.20.0/COPYING %{buildroot}/usr/share/package-licenses/polkit-kde-agent/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
