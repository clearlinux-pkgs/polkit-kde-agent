...
Source0  : https://download.kde.org/stable/plasma/5.25.3/polkit-kde-agent-1-5.25.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.3/polkit-kde-agent-1-5.25.3.tar.xz.sig
...
%prep
%setup -q -n polkit-kde-agent-1-5.25.3
cd %{_builddir}/polkit-kde-agent-1-5.25.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657636427
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/polkit-kde-agent-1-5.25.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/polkit-kde-agent/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/polkit-kde-agent-1-5.25.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/polkit-kde-agent/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
