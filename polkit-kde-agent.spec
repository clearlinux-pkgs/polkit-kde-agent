...
Source0  : https://download.kde.org/stable/plasma/5.16.4/polkit-kde-agent-1-5.16.4.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.16.4/polkit-kde-agent-1-5.16.4.tar.xz.sig
...
%prep
%setup -q -n polkit-kde-agent-1-5.16.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564519453
mkdir -p clr-build
pushd clr-build
